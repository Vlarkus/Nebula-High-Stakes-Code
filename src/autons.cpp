...
Routine routines[] = {
    ...
    Routine("Skills", "Skills routine. Credit to Faaz :)", []() {
        ...
        // chassis.follow(decoder["Path 17"], 15, 1000); //intake and hold ring 1 (no mogo yet)
        // pros::delay(1000);
        // INTAKE::in();
        // pros::delay(500);
        // INTAKE::stop();
        // chassis.turnToHeading(0,1000);
        // chassis.follow(decoder["Path 18"], 15, 1000); //intake and hold ring 2 (no mogo yet)
        // pros::delay(1000);
        // INTAKE::in();
        // pros::delay(200);
        // INTAKE::stop();
        // chassis.turnToHeading(225, 1000);   
        // chassis.follow(decoder["Path 19"], 15, 1000, false);
        // pros::delay(2000);
        // MOGO::close();
        // INTAKE::in();
        ...
        // pros::delay(1000);
        // chassis.follow(decoder["Path 24"], 15, 1000, false);
        // chassis.turnToHeading(264, 1000);
        // chassis.follow(decoder["Path 25"], 15, 1000, false);
        // pros::delay(2000);
        // MOGO::open();
        // pros::delay(500);
        // chassis.follow(decoder["Path 26"], 15, 1000);
        // chassis.turnToHeading(330, 100);
        // chassis.follow(decoder["Path 27"], 15, 1000, false);
        // pros::delay(2000);
        // MOGO::close();
